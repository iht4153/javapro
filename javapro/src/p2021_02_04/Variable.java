...
//			byte b1 = 10;		// -128 ~ 127
			...
			int i = 1000;		// -21억 ~ 21억
//			int j = 3.14		// 오류발생 : 자료형과 데이터값이 일치되어야 한다.
			long l = 10000;		//
		...
		// 3. 문자형 변수
			char c1 = 'A';
			char c2 = '안';
//			char c3 = 'AB';		// 오류발생 : 1개의 데이터만 저장 가능함
//			char c4 = "A";		// 데이터 좌.우 외따옴표 사용
		...
		// 참조형 : Array(배열), Class(클래스), Interface(인터페이스 Collection)
		// 5. 참조형 변수 : Array - 동일한 자료형의 데이터를 저장하는 정적인 자료구조
...
//			List list = new List();	// 오류발생 : 인터페이스는 자체적으로 객체 생성을 할 수 없다.
			...
			List list = new ArrayList();	// 업캐스팅 / 레퍼런스 형변환
